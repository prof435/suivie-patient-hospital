        ...
        <div className="ms-body">
            ...
            {chats?.length ? chats.map((chat) => (
                ...
                <div className="chat-input">
                    <input  value={message} onKeyPress={handleKeyPress} onChange={(e) => setMessage(e.target.value)} type="text" placeholder="Tapez un message..." />
                    <button type="button" onClick={handleSubmit}><i className="fa fa-paper-plane-o"></i>Envoyer</button>
                </div>
        </div>
    );
};
