        ...
        <>
            ...
            <div>
                ...
                */}
                ...
                <div class="container mt-4 bootstrap snippets bootdey">
                                ...
                                <div class="list-group lg-alt">
                                    {chatrooms?.map((chatroom, index)=>(
                                        ...
                                        <div class="media-body">
                                            <small class="list-group-item-heading">  {user?.role === "Medecin" ? chatroom?.Patient?.Utilisateur?.nom:chatroom?.Medecin?.Utilisateur?.prenom}</small><br/>
                                            <small class="list-group-item-text c-gray">{chatroom?.Messages[0]?.contenu.substring(0, 15)} ..</small>
                                        </div>
                                    </a>
                                    ))}
